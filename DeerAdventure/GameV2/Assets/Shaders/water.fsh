...
// For LICENSE information please see THIRD_PARTY_NOTICES.md in the repo root.
//
// Copied verbatim from the SpriteKitShaders demo, apart from this line. This is
// the known-good baseline: it is proven to survive Apple's GLSL to Metal
// transliteration. Change it one step at a time, checking each step on device.
//
